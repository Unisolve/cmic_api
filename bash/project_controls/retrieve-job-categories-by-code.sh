#!/bin/bash
# name:    retrieve-job-categories-by-code.sh
# process: Retrieve Job Categories By Code
#          GET /jc-rest-api/rest/1/jcjobcategory?limit=3&offset=0
# docs:    https://developers.cmicglobal.com/apidocs/retrieve-job-categories-by-code

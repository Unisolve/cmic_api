#!/bin/bash
# name:    retrieve-a-specific-jc-job-category-by-vuuid.sh
# process: Retrieve a specific JC Job Category By VUUID
#          GET /jc-rest-api/rest/1/jcjobcategory?limit=3&offset=0
# docs:    https://developers.cmicglobal.com/apidocs/retrieve-a-specific-jc-job-category-by-vuuid

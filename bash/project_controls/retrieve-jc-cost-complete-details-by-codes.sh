#!/bin/bash
# name:    retrieve-jc-cost-complete-details-by-codes.sh
# process: Retrieve JC Cost Complete Details By Codes
#          GET /jc-rest-api/rest/1/jccostcompletedetail?limit=3&offset=0
# docs:    https://developers.cmicglobal.com/apidocs/retrieve-jc-cost-complete-details-by-codes

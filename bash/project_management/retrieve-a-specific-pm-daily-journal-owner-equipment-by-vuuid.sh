#!/bin/bash
# name:    retrieve-a-specific-pm-daily-journal-owner-equipment-by-vuuid.sh
# process: Retrieve a Specific PM Daily Journal Owner Equipment By VUUID
#          GET /pm-rest-api/rest/1/pmdailyjouroeqp?limit=3&offset=0
# docs:    https://developers.cmicglobal.com/apidocs/retrieve-a-specific-pm-daily-journal-owner-equipment-by-vuuid

#!/bin/bash
# name:    retrieve-a-specific-sc-header-by-vuuid.sh
# process: Retrieve a Specific SC Header By VUUID
#          GET /pm-rest-api/rest/1/scmast?limit=3&offset=0
# docs:    https://developers.cmicglobal.com/apidocs/retrieve-a-specific-sc-header-by-vuuid

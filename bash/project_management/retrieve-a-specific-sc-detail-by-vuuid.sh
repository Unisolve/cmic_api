#!/bin/bash
# name:    retrieve-a-specific-sc-detail-by-vuuid.sh
# process: Retrieve a Specific SC Detail By VUUID
#          GET /pm-rest-api/rest/1/scsched?limit=3&offset=0
# docs:    https://developers.cmicglobal.com/apidocs/retrieve-a-specific-sc-detail-by-vuuid

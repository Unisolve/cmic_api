#!/bin/bash
# name:    retrieve-pm-daily-journal-tasks-by-code.sh
# process: Retrieve PM Daily Journal Tasks By Code
#          GET /pm-rest-api/rest/1/pmdailyjourtask?limit=3&offset=0
# docs:    https://developers.cmicglobal.com/apidocs/retrieve-pm-daily-journal-tasks-by-code

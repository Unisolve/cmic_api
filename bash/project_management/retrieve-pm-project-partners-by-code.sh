#!/bin/bash
# name:    retrieve-pm-project-partners-by-code.sh
# process: Retrieve PM Project Partners By Code
#          GET /pm-rest-api/rest/1/pmprojpartner?limit=3&offset=0
# docs:    https://developers.cmicglobal.com/apidocs/retrieve-pm-project-partners-by-code

#!/bin/bash
# name:    retrieve-a-specific-pm-project-item-phase-segment-sum-by-vuuid.sh
# process: Retrieve a Specific PM Project Item Phase Segment Sum By VUUID
#          GET /pm-rest-api/rest/1/pmprojectitemphssegmsum?limit=3&offset=0
# docs:    https://developers.cmicglobal.com/apidocs/retrieve-a-specific-pm-project-item-phase-segment-sum-by-vuuid

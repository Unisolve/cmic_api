#!/bin/bash
# name:    retrieve-pm-daily-journal-field-force-by-code.sh
# process: Retrieve PM Daily Journal Field Force By Code
#          GET /pm-rest-api/rest/1/pmdailyjourff?limit=3&offset=0
# docs:    https://developers.cmicglobal.com/apidocs/retrieve-pm-daily-journal-field-force-by-code

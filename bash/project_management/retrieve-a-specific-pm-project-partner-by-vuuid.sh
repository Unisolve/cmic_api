#!/bin/bash
# name:    retrieve-a-specific-pm-project-partner-by-vuuid.sh
# process: Retrieve a Specific PM Project Partner By VUUID
#          GET /pm-rest-api/rest/1/pmprojpartner?limit=3&offset=0
# docs:    https://developers.cmicglobal.com/apidocs/retrieve-a-specific-pm-project-partner-by-vuuid

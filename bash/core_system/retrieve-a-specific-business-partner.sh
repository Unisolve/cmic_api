#!/bin/bash
# name:    retrieve-a-specific-business-partner.sh
# process: Retrieve a specific  Business Partner
#          GET /sys-rest-api/rest/1/businesspartner?limit=3&offset=0
# docs:    https://developers.cmicglobal.com/apidocs/retrieve-a-specific-business-partner

#!/bin/bash
# name:    retrieve-company-access-by-vuuid.sh
# process: Retrieve Company Access By VUUID
#          GET /sys-rest-api/rest/1/sdcompanyaccess?limit=3&offset=0
# docs:    https://developers.cmicglobal.com/apidocs/retrieve-company-access-by-vuuid

#!/bin/bash
# name:    retrieve-a-specific-document-by-vuuid.sh
# process: Retrieve a Specific Document By VUUID
#          GET /sys-rest-api/rest/1/sysrelateddocquery?limit=3&offset=0
# docs:    https://developers.cmicglobal.com/apidocs/retrieve-a-specific-document-by-vuuid

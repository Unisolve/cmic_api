#!/bin/bash
# name:    retrieve-a-specific-sd-object-audit-current-state-by-vuuid.sh
# process: Retrieve a Specific SD Object Audit Current State By VUUID
#          GET /sys-rest-api/rest/1/sdobjectauditcurrstat?limit=3&offset=0
# docs:    https://developers.cmicglobal.com/apidocs/retrieve-a-specific-sd-object-audit-current-state-by-vuuid

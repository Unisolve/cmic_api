#!/bin/bash
# name:    retrieve-a-specific-ap-vendor-by-vuuid.sh
# process: Retrieve a Specific AP Vendor by VUUID
#          GET /ap-rest-api/rest/1/apvendor?limit=3&offset=0
# docs:    https://developers.cmicglobal.com/apidocs/retrieve-a-specific-ap-vendor-by-vuuid

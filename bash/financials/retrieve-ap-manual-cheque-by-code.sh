#!/bin/bash
# name:    retrieve-ap-manual-cheque-by-code.sh
# process: Retrieve AP Manual Cheque by Code
#          GET /ap-rest-api/rest/1/manualcheck?limit=3&offset=0
# docs:    https://developers.cmicglobal.com/apidocs/retrieve-ap-manual-cheque-by-code

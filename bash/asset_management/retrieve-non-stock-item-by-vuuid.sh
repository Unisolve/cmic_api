#!/bin/bash
# name:    retrieve-non-stock-item-by-vuuid.sh
# process: Retrieve Non-Stock Item By VUUID
#          GET /po-rest-api/rest/1/poNonStockItem?limit=3&offset=0
# docs:    https://developers.cmicglobal.com/apidocs/retrieve-non-stock-item-by-vuuid

#!/bin/bash
# name:    retrieve-posted-equipment-transaction-location-transfers-by-equipment-code.sh
# process: Retrieve Posted Equipment Transaction Location Transfers By Equipment Code
#          GET /em-rest-api/rest/1/emtranpostactloc?limit=3&offset=0
# docs:    https://developers.cmicglobal.com/apidocs/retrieve-posted-equipment-transaction-location-transfers-by-equipment-code

#!/bin/bash
# name:    retrieve-a-specific-inventory-posted-transaction-by-vuuid.sh
# process: Retrieve a Specific Inventory Posted Transaction By VUUID
#          GET /ci-rest-api/rest/1/citranposted?limit=3&offset=0
# docs:    https://developers.cmicglobal.com/apidocs/retrieve-a-specific-inventory-posted-transaction-by-vuuid

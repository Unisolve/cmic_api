#!/bin/bash
# name:    retrieve-equipment-actual-locations-by-code.sh
# process: Retrieve Equipment Actual Locations By Code
#          GET /em-rest-api/rest/1/emactloc?limit=3&offset=0
# docs:    https://developers.cmicglobal.com/apidocs/retrieve-equipment-actual-locations-by-code

#!/bin/bash
# name:    retrieve-a-specific-inventory-location-by-vuuid-1.sh
# process: Retrieve a Specific Inventory Location By VUUID
#          GET /ci-rest-api/rest/1/cilocation?limit=3&offset=0
# docs:    https://developers.cmicglobal.com/apidocs/retrieve-a-specific-inventory-location-by-vuuid-1

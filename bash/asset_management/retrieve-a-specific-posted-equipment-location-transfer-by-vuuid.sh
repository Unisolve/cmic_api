#!/bin/bash
# name:    retrieve-a-specific-posted-equipment-location-transfer-by-vuuid.sh
# process: Retrieve a Specific Posted Equipment Location Transfer By VUUID
#          GET /em-rest-api/rest/1/emtranpostactloc?limit=3&offset=0
# docs:    https://developers.cmicglobal.com/apidocs/retrieve-a-specific-posted-equipment-location-transfer-by-vuuid
